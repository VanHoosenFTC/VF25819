...
public class AutonConstants {
    ...
    public static double shootingTime = .75;

    public static double thirdShootingTime = 1.75;

    public static double transitionWait = 0;

    public static Pose blueFrontScorePose = new Pose(51, 87, Math.toRadians(310));
    public static Pose blueFrontProtoScorePose = new Pose(45, 91, Math.toRadians(315));
    public static Pose blueFrontStartPose = new Pose(30, 136, Math.toRadians(270));
    public static Pose blueFrontProtoStartPose = new Pose(18,117, Math.toRadians(315));
    public static Pose blueFrontEndPose = new Pose(30, 48, Math.toRadians(180));
public static Pose blueFrontOpenGateStage = new Pose(33,71, Math.toRadians(180));
public static Pose blueFrontOpenGate = new Pose(14, 71,Math.toRadians(180));
    public static Pose blueFrontProtoEndPose = new Pose(20, 104, Math.toRadians(180));
    public static Pose blueFrontPickUpOneStage = new Pose(42, 74, Math.toRadians(180));

    public static Pose blueFrontProtoPickUpOneStage = new Pose(50,68, Math.toRadians(180));
    public static Pose blueFrontPickUpOne = new Pose(10, 74, Math.toRadians(180));

    public static Pose blueFrontProtoPickUpOne = new Pose(15,68, Math.toRadians(180));
    public static Pose blueFrontPickUpTwoStage = new Pose(42, 50, Math.toRadians(180));

    public static Pose blueFrontProtoPickUpTwoStage = new Pose(40,44, Math.toRadians(180));
    public static Pose blueFrontPickUpTwo = new Pose(10, 50, Math.toRadians(180));

    public static Pose blueFrontProtoPickUpTwo = new Pose(15,44,Math.toRadians(180));
    public static Pose redFrontStartPose = new Pose(114, 136, Math.toRadians(270));

    public static Pose redFrontProtoStartPose = new Pose(117, 127, Math.toRadians(225));
    ...
    public static Pose redFrontProtoEndPose = new Pose(87,126, Math.toRadians(0));
    public static Pose redFrontSafePose = new Pose(120, 100, Math.toRadians(180));

    public static Pose redFrontPickUpOneStage = new Pose(85, 83, Math.toRadians(0));
    public static Pose redFrontProtoPickUpOneStage = new Pose(87, 83, Math.toRadians(0));
    public static Pose redFrontPickUpOne = new Pose(118, 104, Math.toRadians(0));

    public static Pose redFrontProtoPickUpOne = new Pose(123, 83, Math.toRadians(0));
