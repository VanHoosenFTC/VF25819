...
public class BlueBackReloadDouble extends NextFTCOpMode {
    ...
    private static final Pose pickUpOneStage = new Pose(40, 27, Math.toRadians(180));
    private static final Pose pickUpOne= new Pose(11, 27, Math.toRadians(180));
...
//    private static final Pose pickUpOne= new Pose(110, 36, Math.toRadians(0));
    ...
    private static final Pose pickUpTwoStage = new Pose(40, 47, Math.toRadians(180));
    private static final Pose pickUpTwo= new Pose(12, 47, Math.toRadians(180));
